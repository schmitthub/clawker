...
- System packages you've specified (`build.packages`) and any declared language toolchains
...
The claude harness bundle bakes a prompt file into its image at `/etc/claude-code/CLAUDE.md`. Claude Code automatically loads this file, giving the agent awareness of its containerized environment without any user configuration.
