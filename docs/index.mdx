...
- **Harness bundles** -- Claude Code and Codex ship built in; per-project images layer your packages, language toolchains, and custom build instructions on a pinned Debian substrate, and you can author your own harness bundles
