...
* [clawker firewall prune](clawker_firewall_prune) - Reset firewall rules to the current project config
...
* [clawker firewall up](clawker_firewall_up) - Start the firewall stack
