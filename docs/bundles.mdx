...
which is how you iterate on a bundle you are authoring.
...
`clawker bundle remove <namespace.name>` purges a bundle's cached content:
...
tells you when that is the case. To make a bundle unavailable entirely, delete
its `bundles:` entry as well.
