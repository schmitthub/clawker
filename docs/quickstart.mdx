...
<CardGroup cols={2}>
  ...
  <Card title="Harnesses" icon="cubes" href="/harnesses">
    Select, register, and run coding-agent harnesses beyond the built-in claude and codex
  </Card>
  <Card title="Stacks" icon="cube" href="/stacks">
    Language toolchains you layer into an image — the shipped stacks and how to register your own
  </Card>
