...
This means only one domain can be whitelisted per non-TLS port — a [tracked limitation](https://github.com/schmitthub/clawker/issues/235), deferred for after the control plane work. See the [Firewall guide](/firewall#protocol-behavior) for details.
