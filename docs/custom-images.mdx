  ...
  instructions:
    copy:
      - src: "./config/eslint.json"
        dest: "/home/clawker/.eslintrc.json"
        chown: "clawker:clawker"
...
build:
  inject:
    ...
    after_user_setup:
      - "RUN mkdir -p /home/clawker/.config"
    after_user_switch:
      - "COPY --chown=clawker:clawker ./dotfiles/ /home/clawker/"
    user_commands:
