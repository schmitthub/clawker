...
Tags are harness-keyed: `-t NAME` builds that registered harness, and the resulting tag *is* the harness name. Building the default harness also stamps the `:default` alias.
