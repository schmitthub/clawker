...
<Info>
Multi-domain support for non-TLS ports is a [tracked limitation](https://github.com/schmitthub/clawker/issues/235). The planned control plane will provide the infrastructure for dynamic IP-based routing that solves this without brittle static IP rules. In the meantime, HTTPS git works for most multi-provider setups.
</Info>
