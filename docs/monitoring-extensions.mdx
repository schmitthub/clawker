...
provides. Fresh projects default to `[claude-code]`, so Claude Code telemetry is
captured out of the box; a project that wants no monitoring extensions sets an
empty list.
