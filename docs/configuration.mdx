...
control_plane:
  # gRPC admin API port for the control plane; published to 127.0.0.1 on the host
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `admin_port` | integer | `7443` | gRPC admin API port for the control plane; published to 127.0.0.1 on the host |
