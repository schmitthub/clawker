...
build:
  ...
  packages:  # default: ripgrep | required: false
    - <string>
  # Toolchain definitions your root_run/user_run steps need (e.g. node, go); installed in the shared base image before your instructions run
  toolchains:  # default: n/a | required: false
    - <string>
  instructions:
...
| `toolchains` | string list | — | Toolchain definitions your root_run/user_run steps need (e.g. node, go); installed in the shared base image before your instructions run |
...
harnesses: <value>  # default: n/a | required: false
# Toolchain registry mapping a toolchain name to its definition directory
toolchains: <value>  # default: n/a | required: false
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `toolchains` | object map | — | Toolchain registry mapping a toolchain name to its definition directory |
