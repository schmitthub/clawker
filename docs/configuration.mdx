...
control_plane:
  ...
  # Agent reporting API port (future: clawkerd agent checkins)
  agent_api_port: <integer>  # default: 7444 | required: false
...
| `agent_api_port` | integer | `7444` | Agent reporting API port (future: clawkerd agent checkins) |
