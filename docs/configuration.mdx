...
# Harness registry mapping a harness name to its bundle location and default flag
harnesses: <value>  # default: n/a | required: false
# Stack registry mapping a stack name to its definition directory
stacks: <value>  # default: n/a | required: false
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `harnesses` | object map | — | Harness registry mapping a harness name to its bundle location and default flag |
