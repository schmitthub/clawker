...
build:
  # Harness used when a command doesn't select one (bare name or namespace.bundle.component address)
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `harness` | string | `claude` | Harness used when a command doesn't select one (bare name or namespace.bundle.component address) |
