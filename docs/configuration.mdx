...
build:
  # Harness used when a command doesn't select one (bare name or namespace.bundle.component address); empty = built-in default
  harness: <string>  # default: n/a | required: false
...
monitor:
  ...
  extensions:  # default: n/a | required: false
    - <string>
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `harness` | string | — | Harness used when a command doesn't select one (bare name or namespace.bundle.component address); empty = built-in default |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `extensions` | string list | — | Monitoring extensions this project contributes to the monitoring stack, by name or qualified namespace.bundle.component address; the highest config layer that sets this wins |
