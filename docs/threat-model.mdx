...
- **Immutable releases.** GitHub tag protection rules prevent tags from being deleted or force-pushed. Once a release is published, its artifacts, checksums, and attestations are frozen — a compromised CI pipeline cannot silently replace a previously published binary.
