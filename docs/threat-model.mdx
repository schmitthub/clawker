...
- **Signed commits.** All commits merged to the main branch must be GPG or SSH signed. The branch ruleset enforces signature verification — pull requests containing unsigned or unverified commits are rejected.
