...
- **GitHub artifact attestation.** [SLSA build provenance](https://slsa.dev/) attestations are generated via GitHub's `attest-build-provenance` action, binding each release artifact to the workflow run, runner environment, and source commit.
