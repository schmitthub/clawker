...
- **Signed commits.** All commits to the main branch must be GPG or SSH signed. Branch protection rules enforce signature verification — unsigned or unverified commits are rejected at push time.
