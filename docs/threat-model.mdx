...
Envoy and CoreDNS emit structured access logs (domain, protocol, HTTP path, response codes, DNS query details) that flow into OpenSearch alongside agent telemetry. (see: [Monitoring](/monitoring))
