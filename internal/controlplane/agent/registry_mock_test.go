...
// Add calls AddFunc.
func (mock *RegistryMock) Add(entry Entry) error {
	if mock.AddFunc == nil {
...
func (mock *RegistryMock) Lookup(thumbprint [32]byte, cn string) (*Entry, error) {
...
func (mock *RegistryMock) LookupByContainerID(containerID string) (*Entry, error) {
