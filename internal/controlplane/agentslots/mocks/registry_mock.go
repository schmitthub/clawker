...
//			ConsumeFunc: func(containerID string) (*agentslots.Slot, error) {
...
func (mock *RegistryMock) Consume(containerID string) (*agentslots.Slot, error) {
	...
	return mock.ConsumeFunc(containerID)
}
