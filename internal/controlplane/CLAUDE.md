...
- `agentregistry.Registry` — `agentregistry/mocks/RegistryMock` for `IdentityInterceptor` + `ListAgents` tests that need a deterministic snapshot independent of dockerevents wiring.
