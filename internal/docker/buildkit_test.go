...
func TestBuildKitEnabled_EnvVar(t *testing.T) {
	...
	enabled, err := BuildKitEnabled(context.Background(), &fakePinger{})
...
func TestBuildKitEnabled_EnvVarInvalid(t *testing.T) {
	...
	_, err := BuildKitEnabled(context.Background(), &fakePinger{})
	require.Error(t, err)
...
func TestBuildKitEnabled_PingError(t *testing.T) {
	...
	_, err := BuildKitEnabled(context.Background(), p)
	require.Error(t, err)
