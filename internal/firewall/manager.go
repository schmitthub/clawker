...
func (m *DockerFirewallManager) Bypass(ctx context.Context, containerID string, timeout time.Duration) error {
	const (
...
func (m *DockerFirewallManager) StopBypass(ctx context.Context, containerID string) error {
