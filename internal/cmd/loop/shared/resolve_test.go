...
func TestBuildRunnerOptions_BasicMapping(t *testing.T) {
	...
	cmd := newTestCmd()
	opts := BuildRunnerOptions(loopOpts, &config.Project{}, "myproject", "dev", "Fix tests", "/workspace", nil, cmd.Flags(), nil, logger.Nop())
...
func TestBuildRunnerOptions_ConfigOverrides(t *testing.T) {
	...
	opts := BuildRunnerOptions(loopOpts, &config.Project{}, "proj", "dev", "test", "/workspace", nil, cmd.Flags(), loopCfg, logger.Nop())
...
func TestBuildRunnerOptions_NilConfig(t *testing.T) {
	...
	cmd := newTestCmd()
	opts := BuildRunnerOptions(loopOpts, &config.Project{}, "proj", "dev", "test", "/workspace", nil, cmd.Flags(), nil, logger.Nop())
...
func TestBuildRunnerOptions_NilFlags(t *testing.T) {
	...
	opts := BuildRunnerOptions(loopOpts, &config.Project{}, "proj", "dev", "test", "/workspace", nil, nil, nil, logger.Nop())
