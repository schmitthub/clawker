...
func setupContainerFakes(fake *mock.FakeClient, output string, exitCode int64) {
...
func newTestRunner(t *testing.T, client *mock.FakeClient) (*shared.Runner, *shared.SessionStore, *shared.HistoryStore) {
	t.Helper()
	tmpDir := t.TempDir()
