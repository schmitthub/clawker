...
func setupContainerFakes(fake *mocks.FakeClient, output string, exitCode int64) {
...
func newTestRunner(t *testing.T, client *mocks.FakeClient) (*shared.Runner, *shared.SessionStore, *shared.HistoryStore) {
	t.Helper()
	tmpDir := t.TempDir()
