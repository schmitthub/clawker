...
templates/opensearch-bootstrap/
  ...
  index-templates/
    ...
    clawker-ebpf-egress.json             # eBPF egress event attributes (verdict + attribution + 4-tuple + domain) from netlogger (service.name=ebpf-egress); final_pipeline=envelope-normalize
  ism-policies/
