...
- Disabling firewall does NOT disable CP, clawker-net, mTLS, agentregistry, agentdial→clawkerd Session, ListAgents, or any non-firewall AdminService RPC.
