...
- **TLS inspection**: Envoy terminates TLS for every allowed HTTPS/WSS rule, with certificates signed by the firewall CA. Wildcard TCP chains obtain per-SNI certificates from the CP SDS service over mTLS.
