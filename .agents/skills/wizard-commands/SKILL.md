...
description: Use when adding a prompt or a multi-step wizard to a command: internal/prompter questions, wizard TUI components, WizardModel, RunWizard, and the project init reference implementation.
---

# wizard-commands

Package contracts: `internal/prompter/AGENTS.md`, `internal/tui/AGENTS.md`.
