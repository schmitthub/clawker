---
name: store-editor
description: Use when adding or changing a store editor: internal/storeui adapters, settings or config edit commands, field browsers, and their tests.
---

# store-editor

Package contract and editor checklist: `internal/storeui/AGENTS.md`. This skill holds the full architecture, data flow, test patterns, and gotchas.
