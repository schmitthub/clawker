...
This plugin ships one skill: `skills/clawker-support` — a clawker internals
expert for end users (setup, config, troubleshooting). Its documentation
philosophy is **minimal concrete details; point at live docs**.
...
2. Bump the patch version in `plugin.json` (see Versioning — the release
