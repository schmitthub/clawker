...
| | Cost | Local | Deny‑default egress | Allow‑list | DNS block | Domain‑native | MITM | Path/ method rules | Proto breadth | Live reload | Timed bypass | Fail closed | Per‑req audit | Super­vision | Dash­boards | Fleet | Cred fwd | Browser auth | Bind mount | Work­trees | Any agent | Snap­shots |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| **clawker** | free | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ⚠️ |
...
| Modal | $ usage | ❌ | ❌ | ⚠️ | ❌ | † | ❌ | ❌ | ⚠️ | ✅ | ❌ | ❌ | ⚠️ | ⚠️ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ |
| Cloudflare Sandbox SDK | $ usage | ❌ | ❌ | ⚠️ | ⚠️ | ✅ | ✅ | ❌ | ⚠️ | ✅ | ❌ | ❌ | ⚠️ | ❌ | ⚠️ | ⚠️ | ⚠️ | ❌ | ❌ | ❌ | ✅ | ✅ |
