...
One subproject is the exception: the `clawker-plugin/clawker-support/` plugin is licensed separately under the MIT License — see [its LICENSE](clawker-plugin/clawker-support/LICENSE). Everything else in this repository is AGPL-3.0-or-later as described below.
