...
>
> I have not had time to properly vet this release's code, stability, or security. It's a major change to how clawker builds and runs agents, but I rushed it out the door to capitalize on temporary Fable access. I've decided to release it now but expect rough edges. The heart of it is an extensibility system for your own container dev stacks, monitoring dashboards, and most importantly harnesses, all distributable as bundles you can install from a git repository or a local directory. Out of the box you get the original Claude Code experience plus an embedded Codex PoC.
>
