...
- **Added:** Docs: [Harness Bundles](https://docs.clawker.dev/harness-bundles), [Toolchains](https://docs.clawker.dev/toolchains), and [Upgrading](https://docs.clawker.dev/upgrading) guides.
