...
| `clawker-globals` | Global shared volume for credentials persistence across all projects/agents; mounted at `~/.clawker-globals`, entrypoint symlinks `~/.claude/.credentials.json` to it |
