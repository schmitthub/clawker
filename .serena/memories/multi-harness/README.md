...
| `harness-research-opencode-pi.md` | Live-verified recon for opencode + pi bundles — DEFERRED by user 2026-07-07: adding them is the planned UAT exercise for the harness-toolchain-dev skill |
