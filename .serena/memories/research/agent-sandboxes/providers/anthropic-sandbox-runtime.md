...
Sources:
- https://github.com/anthropic-experimental/sandbox-runtime/blob/main/README.md — "without requiring a container" (no VM/container boot step in the mem:architecture); no benchmark figures present in the document
