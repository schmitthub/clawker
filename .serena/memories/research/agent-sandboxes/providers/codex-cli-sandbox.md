...
## Unknowns & caveats
- **Blocked**: `https://openai.com/index/running-codex-safely/` returned HTTP 403 Forbidden to WebFetch (likely bot protection) — this official OpenAI blog post on Codex safety mem:architecture could not be read directly; findings here rely on developers.openai.com/learn.chatgpt.com docs and search-engine synthesis of that same domain instead.
