...
- Package contract: `internal/monitor/AGENTS.md`. Runtime checks: `internal/monitor/AGENTS.md` → Runtime UAT. Detailed map and verification workflow: `.agents/skills/monitoring-checks/SKILL.md`.
