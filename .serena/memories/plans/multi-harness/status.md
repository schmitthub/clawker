...
scratch.** The active design lives in serena `mem:plans/bundle-install/design`
...
| file | purpose |
|---|---|
| `mem:plans/multi-harness/harness-research-opencode-pi` | Live-verified recon for opencode + pi harness bundles (research facts — still valid). |
