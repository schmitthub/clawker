...
- **Bootstrap delivery is UNCONDITIONAL** (NOT gated on `firewall.enable` in settings.yaml). CP ≠ firewall. Loop containers are also new-container paths and got the AgentName plumbing.
