# Docker CLI container options example

This is the example of what is required to properly implement container options in Clawker.

The option properties and flags are not optional, they are cononical and must be followed exactly so that users can fully utilize container options for docker
