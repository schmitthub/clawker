...
| Task 8: top (tabwriter → TablePrinter + Tier 2) | `pending` | — |
| Task 9: stats (tabwriter + HandleError + Tier 2) | `pending` | — |
| Task 10: attach (StreamWithResize → canonical + Tier 2) | `pending` | — |
| Task 11: exec (StreamWithResize → canonical + Tier 2) | `pending` | — |
| Task 12: Cleanup — deprecated helpers + documentation | `pending` | — |
